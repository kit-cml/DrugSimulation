#PBS -N drugsim_ord_static_euler_optimal
#PBS -l nodes=1:ppn=1
...
mkdir result
mpirun -machinefile $PBS_NODEFILE -np $NPROCS ~/marcell/MetaHeart/DrugSimulation/bin/drugsim_ordstatic -input_deck param.txt > logfile
