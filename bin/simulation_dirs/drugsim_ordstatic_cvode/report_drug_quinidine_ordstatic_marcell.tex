...
Cellmodel: O'Hara-Rudy (ORd) (2011)
\\Celltype: endocardium
\\Drug Name: quinidine
...
\begin{figure}[H]
	...
	\caption{Distribution of qNet at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of APD90 at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of APD50 at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of CaD90 at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of CaD50 at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of peak action potential at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of lowest action potential at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of peak calcium concentration at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
...
\begin{figure}[H]
	...
	\caption{Distribution of lowest calcium concentrations  at different concentration levels, from control, cmax1, cmax2, cmax3, and cmax4.}
