#PBS -N drugsim_tomek_postprocessing
...
mkdir results
mpiexec -machinefile $PBS_NODEFILE -np $NPROCS ~/marcell/MetaHeart/DrugSimulation/bin/drugsim_tomek_postprocessing -input_deck param.txt > logfile
