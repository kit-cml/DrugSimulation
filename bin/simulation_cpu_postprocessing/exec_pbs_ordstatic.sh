#PBS -N drugsim_ordstatic_postprocessing
...
mkdir results
mpiexec -machinefile $PBS_NODEFILE -np $NPROCS ~/marcell/MetaHeart/DrugSimulation/bin/drugsim_ordstatic_postprocessing -input_deck param.txt > logfile
